...
const Experience = () => {
  return (
    <section class="h-screen snap-start pt-16 flex flex-col items-center justify-center gap-5">
      <div className="flex">
      ...
      <div className="xl:hidden max-w-[600px] px-5 sm:px-0">
        <div className="text-lg font-black">Fujifilm Business Innovation Vietnam</div>
        <div className="textarea-md font-semibold">July 2025 - Present | Software engineer</div>
        <div className="font-mono">
          Worked closely with cross-functional teams to enhance and develop new features for the MFP
          (Multi-Function Printer), with a strong emphasis on the Panel UI experience. Beyond
          feature development, I proactively created internal tools to improve team efficiency,
          including automated report generation solutions and browser extensions to simplify and
          standardize recurring tasks.
        </div>
        <hr />
        <div className="text-lg font-black">Bosch global software company</div>
        <div className="textarea-md font-semibold">Apr 2022 - Jul 2025 |Frontend developer</div>
        <div className="font-mono">
          An internal project for Bosch, which use to raise e-forms for any kind of requests. My
          responsibilities include developing new features, maintaining the existing codebase.
          Moreover, I also work closely with the customers to understand their needs and provide
          solutions that meet their requirements which helps me to perform as the "Asscociate of the
          month" in Oct 2024
        </div>
        <hr />
        <div className="text-lg font-black">Netcompany</div>
        <div className="textarea-md font-semibold">Jan 2021 - Mar 2022 | QA/QC</div>
        <a href="https://www.sedex.com/vn/" target="_blank" className="link text-emerald-300 block">
          To the site
        </a>
        <div className="font-mono">
          Worked in a UK project named Sedex, which is a global web application that helps companies
          manage and improve their responsible sourcing practices. My responsibilities included
          testing the application, identifying and reporting bugs, and ensuring that the software
